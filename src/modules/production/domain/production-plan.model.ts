...
export interface IProductionPlan extends Document {
  ...
  hourlyEquipments?: Record<string, string>
...
const ProductionPlanSchema = new Schema<IProductionPlan>(
  {
    ...
    stage: { type: String, enum: ['Core', 'Mould', 'Melt', 'Knockout'], required: true },
    ...
    hourlyEquipments: { type: Map, of: String },
    hourlyActuals: { type: Map, of: Number },
    ...
    actualPouredMoulds: { type: Number },
    actuals: {
      pigIron: Number,
      scrap: Number,
      feMn: Number,

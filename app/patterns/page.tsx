...
export default function PatternsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Filters */}
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between py-6 px-6 bg-[#0B101A] border border-sidebar-border rounded-lg min-h-[80px]">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <Popover open={customerOpen} onOpenChange={setCustomerOpen}>
            <PopoverTrigger
              className="flex h-10 w-full sm:w-[240px] items-center justify-between rounded-md border border-sidebar-border bg-[#121A2B] px-3 py-2 text-sm hover:bg-[#1A263D] hover:text-white"
            ...
            <PopoverContent className="w-[240px] p-0 bg-[#121A2B] border-sidebar-border">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredPatterns.map((pattern) => {
          ...
          return (
            <Card
              key={pattern.id}
              className="bg-[#0B101A] border-sidebar-border transition-all duration-200 hover:-translate-y-[2px] hover:shadow-[0_8px_24px_rgba(0,0,0,0.3)] hover:border-[#2E3C5C] overflow-hidden flex flex-col cursor-pointer"
            >
              <div className="p-5 flex-1 space-y-4">
                ...
                <div className="flex justify-between items-start gap-2">
                  ...
                  <Badge variant="outline" className="shrink-0 bg-[#121A2B] border-sidebar-border text-[13px]">
                    {pattern.category}
                  </Badge>
                </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {pattern.mappedProducts.map((prod, idx) => (
                      <Badge
                        key={idx}
                        variant="secondary"
                        className="bg-[#121A2B] text-foreground border-sidebar-border/50 font-normal"
                      >
                        {prod.name}
              ...
              {/* Footer Action */}
              <div className="p-4 bg-[#121A2B]/50 border-t border-sidebar-border">
                <Button
                  variant="outline"
                  onClick={() => {

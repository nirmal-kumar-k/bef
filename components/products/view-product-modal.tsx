...
export function ViewProductModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-full sm:max-w-2xl bg-[#0B101A] border-[#243050] text-foreground">
        <DialogHeader>
        ...
        <div className="py-6 space-y-8">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-lg text-[#F5712E] font-mono mt-1">{product.code}</p>
            </div>
            <div className="bg-[#121A2B] border border-[#243050] rounded-lg px-4 py-2 text-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#121A2B]/50 border border-[#243050] rounded-lg p-4 flex flex-col items-center justify-center min-h-[120px] text-[#5A6E90]">
